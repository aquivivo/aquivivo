...
import { getNeuLoginPath, getNeuPath, getNeuSocialAppPath, withNeuQuery } from './neu-paths.js';
...
function buildHeader(user) {
  ...
  const publicHomeHref = rootedNeuPath('index.html');
  const brandLogoSrc = rootedNeuPath('assets/img/logo.png');
      ...
      <header class="topbar nav-glass neu-shell-header">
        <div class="nav-inner container">
          <a class="brand neu-brand" href="${publicHomeHref}" aria-label="NEU Social App">
            <img src="${brandLogoSrc}" alt="AquiVivo" />
...
function enforceLegalFooterLinks() {
  ...
  const legalLinks = [
    { label: 'Privacidad', href: rootedNeuPath('pages/legal/polityka-prywatnosci.html') },
    { label: 'Terminos', href: rootedNeuPath('pages/legal/regulamin.html') },
    { label: 'Devoluciones', href: rootedNeuPath('pages/legal/zwroty.html') },
    { label: 'Ayuda', href: rootedNeuPath('pages/legal/ayuda.html') },
  ];
  ...
  if (headerMount) {
    try {
      ...
      headerMount.innerHTML = `
        <header class="topbar nav-glass neu-shell-header">
          <div class="nav-inner container">
            <a class="brand neu-brand" href="${rootedNeuPath('index.html')}" aria-label="NEU Social App">
              <img src="${rootedNeuPath('assets/img/logo.png')}" alt="AquiVivo" />
              <span class="neu-brand-copy">
                <strong>NEU</strong>
                <small>Social App</small>
              </span>
