...
import { auth, db } from "../firebase-init.js";
        ...
        limit,
        startAfter,
        writeBatch} from 'https://www.gstatic.com/firebasejs/12.8.0/firebase-firestore.js';
...
`;
    ...
    <div id="metaModal" class="modal-backdrop" style="display: none">
      ...
      >
        ...
        <div style="margin-top: 14px; opacity: 0.85">
          Nivel: <strong id="metaLevel">—</strong>
        </div>

        <label style="display: block; margin-top: 14px; font-weight: 800"
          >Título</label
        >
        <input id="metaTitle" class="input" placeholder="Título del curso" />
        ...
        >
          ...
          <div>
            <label style="display: block; font-weight: 800"
              >Link botón principal (opcional)</label
            >
            <input
              id="metaPrimaryHref"
              class="input"
        ...
        <div
          ...
          "
        >
          Tips: wpisuj kolory w formacie <strong>#RRGGBB</strong>. Jeśli
          zostawisz puste — zostaną domyślne style.
        </div>
        ...
        <div
          ...
          "
        >
          <div style="font-weight: 900">🗑️ Eliminar curso</div>
          <label
            style="
              display: flex;
              gap: 10px;
          ...
          >
            ...
            />
            <span
              >Eliminar también <b>temas (courses)</b> y
          ...
          <div
            ...
            "
          >
            Si no estás segura: elimina solo la tarjeta. El contenido se puede
            borrar después.
          </div>
        </div>
        ...
        >
          ...
          <div style="display: flex; gap: 10px; margin-left: auto">
            ...
            <button id="metaSave" class="btn-yellow">💾 Guardar</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="addCourseModal" class="modal-backdrop" style="display: none">
      ...
      >
        ...
        <p style="margin: 10px 0 0; opacity: 0.8; line-height: 1.35">
          ...
          añaden después (en <strong>courses</strong>).
        </p>
        ...
        >
          ...
          <button id="addCourseCreate" class="btn-yellow">✅ Crear</button>
        </div>
      </div>
    </div>
    ...
    <div id="settingsModal" aria-hidden="true">
      <div class="modalBox">
        <div class="modalHead">
          <h3>⚙️ Ajustes (Planes, precios, botones, promos)</h3>
        ...
        <div class="modalBody">
          ...
          <div id="tabPlans">
            <div class="mini">
              Editas el contenido y el estilo de los bloques de “Planes y
              precios”. Se guarda en <code>site_settings/panel_es</code>.
            </div>

            <div class="hr"></div>

            <h4 style="margin: 0 0 10px; font-size: 16px">A1–A2</h4>
            <div class="grid3">
              <div>
                <label>Precio (texto)</label>
                <input id="set_price_A1A2" placeholder="180 zł / 3 meses" />
              </div>
              <div>
            ...
            <div class="grid2 row">
              <div>
                <label>Color botón (bg) #RRGGBB</label>
                <input id="set_btnBg_A1A2" placeholder="#FCD116" />
              </div>
              <div>
                <label>Color botón (texto) #RRGGBB</label>
            ...
            <div class="grid3">
              <div>
                <label>Precio (texto)</label
                ><input id="set_price_B1" placeholder="250 zł / 3 meses" />
              </div>
              <div>
                <label>Texto botón</label
            ...
            <div class="grid2 row">
              <div>
                <label>Color botón (bg)</label
                ><input id="set_btnBg_B1" placeholder="#FCD116" />
              </div>
              <div>
                <label>Color botón (texto)</label
            ...
            <div class="grid3">
              <div>
                <label>Precio (texto)</label
                ><input id="set_price_B2" placeholder="350 zł / 3 meses" />
              </div>
              <div>
                <label>Texto botón</label
          ...
          <div id="tabPromos" style="display: none">
            <div class="mini">
              Tu “checkout” może użyć tego samego kodu. Tu zapisujemy kody do
            ...
            <div class="grid2 row">
              ...
              <div>
                ...
                <input
                  id="promo_note"
                  placeholder="np. campaña enero / IG / etc."
                />
              </div>
            </div>
            ...
            <h4 style="margin: 0; font-size: 16px">Lista kodów</h4>
