...
function guessTopicEmoji(topic) {
  ...
  const table = [
    ...
    [/podr\u00f3\u017c|podroz|viaj|travel|aeropuert|av[i\u00ed]on|samolot/, '\u2708\uFE0F'], // travel
  ...
  if (rawType.includes('vocab')) return '\uD83D\uDD24'; // vocabulary
  if (rawType.includes('both') || rawType.includes('+')) return '\uD83E\uDDE9'; // mixed
  return '\uD83D\uDCD8'; // lesson
}
