...
const LANDMARKS = [
  ...
  },
  {
    id: 'lazienki',
    emoji: 'ðŸŒ³',
    pl: 'Åazienki KrÃ³lewskie',
    es: 'Parque Åazienki',
    descPl:
      'Åazienki KrÃ³lewskie to park i zespÃ³Å‚ paÅ‚acowy w Warszawie. Latem odbywajÄ… siÄ™ tu koncerty pod pomnikiem Chopina.',
    descEs:
      'Åazienki es un parque y conjunto palaciego en Varsovia. En verano hay conciertos junto al monumento a Chopin.',
    challenge: {
      prompt: 'Åazienki KrÃ³lewskie to park w ___.',
      answer: 'Warszawie|Warszawa',
      tts: 'Åazienki KrÃ³lewskie to park w Warszawie.',
    },
  },
  {
    id: 'wilanow',
  ...
  },
  {
    ...
    pl: 'ÅaÅ„cut',
    es: 'ÅaÅ„cut',
    descPl: 'Zamek w ÅaÅ„cucie sÅ‚ynie z piÄ™knych wnÄ™trz i muzeum powozÃ³w.',
    descEs: 'El castillo de ÅaÅ„cut es famoso por sus interiores y su museo de carruajes.',
    challenge: {
      prompt: 'Zamek w ÅaÅ„cucie sÅ‚ynie z muzeum ___.',
      answer: 'powozÃ³w|powozy',
      tts: 'Zamek w ÅaÅ„cucie sÅ‚ynie z muzeum powozÃ³w.',
    },
  },
  {
    id: 'moszna',
  ...
  },
  {
    ...
    descEs: 'Las ruinas del castillo de Ogrodzieniec estÃ¡n en la Ruta de los Nidos de Ãguilas.',
    challenge: {
...
function openStampModal({ level, topicIdx, topic, isDone, progress, landmark }) {
  ...
  status.textContent = isDone
    ? `âœ… Recompensa ganada Â· Tema ${topicIdx + 1}`
